...
var selectQueryString = reselect.createSelector(selectUrlState, function (urlState) { return urlState.search; })
var selectQueryObject = reselect.createSelector(selectQueryString, function (string) { return qs.parse(string); })
var selectPathname = reselect.createSelector(selectUrlState, function (urlState) { return urlState.pathname; })
var selectHash = reselect.createSelector(selectUrlState, function (urlState) { return urlState.hash; })
var selectHashObject = reselect.createSelector(selectUrlState, function (urlState) { return qs.parse(urlState.hash); })
